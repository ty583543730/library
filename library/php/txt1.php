...
$res=mysql_query("select *from baoming where checked=1");
...
if($num>15)
{
    ...
    {
        $b=15+$a;
        $res=mysql_query("select *from baoming where checked=1 limit $offset,$b");
    }

    else
    {
        $res=mysql_query("select *from baoming where checked=1 limit $offset,15");
    }
}
